...
public class AdminInfo {
    ...
    public AdminInfo(Long id, String lastName, String firstName, Date dateBirth, String phone, String sexe, String email, String password, Boolean etat, byte[] photo, Role role, DepartementInfo departement) {
        this.id = id;
